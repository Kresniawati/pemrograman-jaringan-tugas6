 ...
 * @author Lenovo
 */
public class ReadStreamPushBackReaderTugas {


    private final ReadFileFormTugas view;

    public ReadStreamPushBackReaderTugas(ReadFileFormTugas view) {
        this.view = view;
        ...
        this.view.getBtBaca().addActionListener((ActionEvent e) -> {
            try {
                ...
                Logger.getLogger(ReadStreamPushBackReaderTugas.class.getName()).log(Level.SEVERE, null, ex);
